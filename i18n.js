...
(function (global) {
  ...
  var S = {
    ...
    /* ----- 고객 로그인 ----- */
    'cust.guide': { ko:'마사지를 예약하려면 로그인하세요', en:'Log in to book a massage', th:'เข้าสู่ระบบเพื่อจองนวด', zh:'登录以预约按摩', ja:'ログインして予約しましょう', hi:'मसाज बुक करने के लिए लॉगिन करें', ru:'Войдите, чтобы записаться' },
    'cust.nickPh': { ko:'닉네임 (영어 4자 이상)', en:'Nickname (4+ letters)', th:'ชื่อเล่น (อังกฤษ 4+ ตัว)', zh:'昵称（英文4位以上）', ja:'ニックネーム（英字4文字以上）', hi:'उपनाम (4+ अक्षर)', ru:'Имя (4+ латин. букв)' },
    'cust.pwPh': { ko:'비밀번호 (숫자 포함 6자 이상)', en:'Password (6+, incl. a number)', th:'รหัสผ่าน (6+ มีตัวเลข)', zh:'密码（6位以上，含数字）', ja:'パスワード（数字含む6文字以上）', hi:'पासवर्ड (6+, अंक सहित)', ru:'Пароль (6+, с цифрой)' },
    'cust.login': { ko:'로그인', en:'Log in', th:'เข้าสู่ระบบ', zh:'登录', ja:'ログイン', hi:'लॉगिन', ru:'Войти' },
    'cust.signupQ': { ko:'처음이신가요? 회원가입', en:'New here? Sign up', th:'ครั้งแรก? สมัครเลย', zh:'首次使用？注册', ja:'初めて？登録する', hi:'नया? साइन अप', ru:'Впервые? Регистрация' },
    'cust.nickRule': { ko:'닉네임은 영어 4자 이상이에요', en:'Nickname: 4+ English letters', th:'ชื่อเล่น: อังกฤษ 4 ตัวขึ้นไป', zh:'昵称需英文4位以上', ja:'ニックネームは英字4文字以上', hi:'उपनाम: 4+ अंग्रेज़ी अक्षर', ru:'Имя: 4+ латинских букв' },
    'cust.pwRule': { ko:'비밀번호는 숫자 또는 영어+숫자 6자 이상이에요', en:'Password: 6+ digits, or letters+digits', th:'รหัสผ่าน: 6+ ตัวเลข หรือ ตัวอักษร+ตัวเลข', zh:'密码需6位以上数字，或字母+数字', ja:'パスワードは数字、または英数6文字以上', hi:'पासवर्ड: 6+ अंक, या अक्षर+अंक', ru:'Пароль: 6+ цифр или буквы+цифры' },
    'cust.loginFail': { ko:'닉네임 또는 비밀번호가 맞지 않아요', en:'Wrong nickname or password', th:'ชื่อหรือรหัสผ่านไม่ถูกต้อง', zh:'昵称或密码错误', ja:'ニックネームかパスワードが違います', hi:'गलत उपनाम या पासवर्ड', ru:'Неверное имя или пароль' },
    'cust.taken': { ko:'이미 있는 닉네임이에요 — 로그인하세요', en:'Nickname taken — log in instead', th:'ชื่อนี้มีแล้ว — กรุณาเข้าสู่ระบบ', zh:'昵称已存在 — 请登录', ja:'そのニックネームは使用中 — ログインを', hi:'उपनाम मौजूद है — लॉगिन करें', ru:'Имя занято — войдите' },

    /* ----- 마사지사 쇼케이스(첫화면) ----- */
    'show.headline': { ko:'우리 마사지사를 만나보세요', en:'Meet our therapists', th:'พบกับหมอนวดของเรา', zh:'认识我们的按摩师', ja:'セラピストをご紹介', hi:'हमारे थेरेपिस्ट से मिलें', ru:'Наши мастера' },
    'show.sub': { ko:'마음에 드는 분을 골라 바로 예약하세요', en:'Pick your favorite and book', th:'เลือกคนที่ชอบแล้วจองเลย', zh:'选择您喜欢的并预约', ja:'お気に入りを選んで予約', hi:'पसंदीदा चुनें और बुक करें', ru:'Выберите и запишитесь' },
    'show.book': { ko:'이 분께 예약하기', en:'Book with them', th:'จองกับคนนี้', zh:'预约TA', ja:'この人で予約', hi:'इनके साथ बुक करें', ru:'Записаться к мастеру' },
    ...
    'spa.walkin': { ko:'워크인 (지금 갈게요)', en:'Walk-in (now)', th:'วอล์กอิน (ไปเลย)', zh:'直接到店', ja:'今すぐ来店', hi:'वॉक-इन (अभी)', ru:'Без записи (сейчас)' },
    'spa.walkinHint': { ko:'지금 매장으로 가시면 직원이 순서대로 안내해드려요. 시간을 정해서 가시려면 「시간 예약」을 선택하세요.', en:'Come to the shop now — staff will seat you in order. To pick a time, choose "Reserve".', th:'มาที่ร้านได้เลย พนักงานจะจัดให้ตามคิว — หากต้องการเลือกเวลา กด「จองเวลา」', zh:'现在直接到店，店员会按顺序安排。想指定时间请选「预约」。', ja:'今すぐご来店ください。スタッフが順番にご案内します。時間指定は「時間予約」へ。', hi:'अभी दुकान आएँ — स्टाफ़ क्रम से बैठाएगा। समय चुनने के लिए「रिज़र्व」चुनें।', ru:'Приходите сейчас — примут по очереди. Чтобы выбрать время — «Бронь».' },
    'spa.noSlot': { ko:'이 조합으로 가능한 시간이 없어요 — 다른 마사지사·룸·시술로 바꿔보세요', en:'No open time for this combo — try another therapist/room/service', th:'ไม่มีเวลาว่างสำหรับชุดนี้ — ลองเปลี่ยนหมอนวด/ห้อง/บริการ', zh:'该组合暂无可约时间 — 换按摩师/房间/服务试试', ja:'この組み合わせは空き時間がありません — 他のセラピスト/部屋/メニューをお試しを', hi:'इस संयोजन के लिए समय नहीं — दूसरा थेरेपिस्ट/रूम/सेवा आज़माएँ', ru:'Нет свободного времени — смените мастера/кабинет/услугу' },
    'spa.timePick': { ko:'도착 예정 시각', en:'Arrival time', th:'เวลาที่จะมาถึง', zh:'到店时间', ja:'到着予定時刻', hi:'पहुँचने का समय', ru:'Время прихода' }
  };
