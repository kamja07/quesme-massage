...
(function (global) {
  ...
  var S = {
    ...
    'spa.reserve': { ko:'마사지 예약', en:'Book massage', th:'จองนวด', zh:'预约按摩', ja:'マッサージ予約', hi:'मसाज बुक करें', ru:'Записаться на массаж' },
    ...
    'spa.privateOnly': { ko:'프리티 마사지는 개인룸만 가능해요', en:'Pretty massage uses a private room only', th:'นวดพริตตี้ ใช้ห้องส่วนตัวเท่านั้น', zh:'精选按摩仅限私人房间', ja:'プリティは個室のみ', hi:'प्रीमियम मसाज केवल निजी रूम में', ru:'Премиум-массаж — только в отдельном кабинете' },
    'spa.timeMenu': { ko:'시간 · 메뉴 선택', en:'Time & menu', th:'เลือกเวลาและเมนู', zh:'选择时间和服务', ja:'時間・メニュー', hi:'समय और मेन्यू', ru:'Время и услуга' },
    'pay.title': { ko:'예약금 입금', en:'Pay deposit', th:'ชำระมัดจำ', zh:'支付订金', ja:'予約金の入金', hi:'जमा भुगतान', ru:'Внести депозит' },
    'pay.deposit': { ko:'예약금', en:'Deposit', th:'มัดจำ', zh:'订金', ja:'予約金', hi:'जमा राशि', ru:'Депозит' },
    'pay.m.thai': { ko:'태국 계좌', en:'Thai bank', th:'บัญชีไทย', zh:'泰国账户', ja:'タイ口座', hi:'थाई बैंक', ru:'Тайский счёт' },
    'pay.m.korea': { ko:'한국 계좌', en:'Korean bank', th:'บัญชีเกาหลี', zh:'韩国账户', ja:'韓国口座', hi:'कोरियाई बैंक', ru:'Кор. счёт' },
    'pay.m.qr': { ko:'QR 결제', en:'QR', th:'QR', zh:'QR', ja:'QR', hi:'QR', ru:'QR' },
    'pay.bank': { ko:'은행', en:'Bank', th:'ธนาคาร', zh:'银行', ja:'銀行', hi:'बैंक', ru:'Банк' },
    'pay.acc': { ko:'계좌번호', en:'Account', th:'เลขบัญชี', zh:'账号', ja:'口座番号', hi:'खाता', ru:'Счёт' },
    'pay.holder': { ko:'예금주', en:'Holder', th:'ชื่อบัญชี', zh:'户名', ja:'名義', hi:'धारक', ru:'Владелец' },
    'pay.scan': { ko:'QR을 스캔해 입금', en:'Scan QR to pay', th:'สแกน QR เพื่อจ่าย', zh:'扫码支付', ja:'QRをスキャンして入金', hi:'भुगतान हेतु QR स्कैन करें', ru:'Сканируйте QR' },
    'pay.copied': { ko:'복사됨 ✓', en:'Copied ✓', th:'คัดลอกแล้ว ✓', zh:'已复制 ✓', ja:'コピー済 ✓', hi:'कॉपी ✓', ru:'Скопировано ✓' },
    'pay.noAcct': { ko:'입금 정보가 아직 없어요 — 샵에 문의', en:'No payment info yet — ask the shop', th:'ยังไม่มีข้อมูลการชำระ', zh:'暂无收款信息', ja:'入金情報がありません', hi:'भुगतान जानकारी नहीं', ru:'Нет реквизитов' },
    'pay.slipHd': { ko:'송금 슬립 올리기', en:'Upload transfer slip', th:'อัปโหลดสลิปโอนเงิน', zh:'上传转账凭证', ja:'送金スリップを添付', hi:'ट्रांसफर स्लिप अपलोड', ru:'Загрузите чек' },
    'pay.upload': { ko:'슬립 사진 선택', en:'Choose slip photo', th:'เลือกรูปสลิป', zh:'选择凭证照片', ja:'スリップ写真を選ぶ', hi:'स्लिप फोटो चुनें', ru:'Выбрать чек' },
    'pay.submit': { ko:'입금 완료 — 슬립 제출', en:'I paid — submit slip', th:'จ่ายแล้ว — ส่งสลิป', zh:'已付款 — 提交凭证', ja:'入金済 — スリップ送信', hi:'भुगतान हुआ — स्लिप भेजें', ru:'Оплатил — отправить' },
    'pay.submitErr': { ko:'제출 실패 — 잠시 후 다시', en:'Submit failed — try again', th:'ส่งไม่สำเร็จ', zh:'提交失败', ja:'送信失敗', hi:'भेजना विफल', ru:'Ошибка отправки' },
    'pay.readErr': { ko:'사진을 읽지 못했어요. 다른 사진으로 시도해 주세요.', en:"Couldn't read the photo. Try another.", th:'อ่านรูปไม่ได้', zh:'无法读取照片', ja:'写真を読めません', hi:'फोटो नहीं पढ़ सका', ru:'Не удалось прочитать фото' },
    'pay.fmtErr': { ko:'지원되지 않는 형식이에요 (HEIC 등). JPG/PNG로 올려주세요.', en:'Unsupported format (HEIC). Use JPG/PNG.', th:'รูปแบบไม่รองรับ (HEIC)', zh:'格式不支持 (HEIC)', ja:'未対応形式 (HEIC)', hi:'असमर्थित प्रारूप', ru:'Формат не поддерживается' },
    'pay.waitTitle': { ko:'입금 확인 대기중', en:'Awaiting confirmation', th:'รอยืนยันการชำระ', zh:'等待确认', ja:'入金確認待ち', hi:'पुष्टि प्रतीक्षारत', ru:'Ожидание подтверждения' },
    'pay.waitMsg': { ko:'슬립이 제출됐어요. 샵에서 입금을 확인하면 예약이 확정됩니다.', en:'Slip submitted. Booking confirms once the shop verifies your payment.', th:'ส่งสลิปแล้ว รอร้านยืนยัน', zh:'凭证已提交，店家确认后预约成立', ja:'スリップ送信済。確認後に予約確定。', hi:'स्लिप भेजी गई। दुकान पुष्टि करेगी।', ru:'Чек отправлен. Ждём подтверждения.' },
    'spa.choose': { ko:'선택', en:'Choose', th:'เลือก', zh:'选择', ja:'選択', hi:'चुनें', ru:'Выбрать' },
    'spa.prettyMassage': { ko:'프리티 마사지', en:'Pretty massage', th:'นวดพริตตี้', zh:'精选按摩', ja:'プリティマッサージ', hi:'प्रीमियम मसाज', ru:'Премиум-массаж' },
    'spa.proMassage': { ko:'전문 마사지', en:'Pro massage', th:'นวดมืออาชีพ', zh:'专业按摩', ja:'専門マッサージ', hi:'विशेषज्ञ मसाज', ru:'Профи-массаж' },
    'spa.chosen': { ko:'선택됨', en:'Chosen', th:'เลือกแล้ว', zh:'已选择', ja:'選択中', hi:'चुना गया', ru:'Выбрано' },
    'common.back': { ko:'뒤로', en:'Back', th:'ย้อนกลับ', zh:'返回', ja:'戻る', hi:'पीछे', ru:'Назад' },
    'common.next': { ko:'다음', en:'Next', th:'ถัดไป', zh:'下一步', ja:'次へ', hi:'आगे', ru:'Далее' },
    'auth.tag': { ko:'로그인하고 마사지사를 만나보세요', en:'Log in to browse & book', th:'เข้าสู่ระบบเพื่อจองคิว', zh:'登录后浏览并预约', ja:'ログインして予約', hi:'ब्राउज़ करने हेतु लॉगिन', ru:'Войдите, чтобы записаться' },
    'sf.book': { ko:'지금 예약하기', en:'Book now', th:'จองเลย', zh:'立即预约', ja:'今すぐ予約', hi:'अभी बुक करें', ru:'Записаться' },
    'sf.loading': { ko:'불러오는 중…', en:'Loading…', th:'กำลังโหลด…', zh:'加载中…', ja:'読み込み中…', hi:'लोड हो रहा…', ru:'Загрузка…' },
    'sf.gallery': { ko:'매장 사진', en:'Photos', th:'รูปร้าน', zh:'门店照片', ja:'店内写真', hi:'तस्वीरें', ru:'Фото' },
    'sf.noPhoto': { ko:'사진 준비 중이에요', en:'Photos coming soon', th:'กำลังเตรียมรูป', zh:'照片准备中', ja:'写真準備中', hi:'तस्वीरें जल्द', ru:'Фото скоро' },
    'sf.features': { ko:'매장 특징', en:'Highlights', th:'จุดเด่น', zh:'门店特色', ja:'特徴', hi:'विशेषताएँ', ru:'Особенности' },
    'sf.about': { ko:'매장 소개', en:'About', th:'เกี่ยวกับร้าน', zh:'门店介绍', ja:'店舗紹介', hi:'परिचय', ru:'О салоне' },
    'sf.info': { ko:'이용 안내', en:'Info', th:'ข้อมูล', zh:'信息', ja:'ご案内', hi:'जानकारी', ru:'Информация' },
    'sf.area': { ko:'지역', en:'Area', th:'พื้นที่', zh:'区域', ja:'エリア', hi:'क्षेत्र', ru:'Район' },
    'sf.hours': { ko:'영업시간', en:'Hours', th:'เวลาทำการ', zh:'营业时间', ja:'営業時間', hi:'समय', ru:'Часы' },
    'sf.phone': { ko:'전화', en:'Phone', th:'โทร', zh:'电话', ja:'電話', hi:'फ़ोन', ru:'Телефон' },
    'sf.therapists': { ko:'마사지사 {n}명', en:'{n} therapists', th:'หมอนวด {n} คน', zh:'{n}位按摩师', ja:'セラピスト{n}名', hi:'{n} थेरेपिस्ट', ru:'{n} मастеров' },
    'venue.roomsNow': { ko:'지금 가능한 룸', en:'Rooms available now', th:'ห้องว่างตอนนี้', zh:'现在可用房间', ja:'今空いてる部屋', hi:'अभी उपलब्ध रूम', ru:'Свободные комнаты' },
    'venue.pickNext': { ko:'다음에서 룸과 이용 시간을 선택하세요', en:'Pick a room & package next', th:'เลือกห้องและแพ็กเกจถัดไป', zh:'下一步选择房间与套餐', ja:'次で部屋とパックを選択', hi:'आगे रूम व पैकेज चुनें', ru:'Далее выберите комнату и пакет' },
    'venue.room': { ko:'룸 선택', en:'Choose a room', th:'เลือกห้อง', zh:'选择房间', ja:'部屋を選ぶ', hi:'रूम चुनें', ru:'Выберите комнату' },
    'venue.package': { ko:'이용 패키지 (시간·요금)', en:'Package (time · price)', th:'แพ็กเกจ (เวลา·ราคา)', zh:'套餐（时长·价格）', ja:'パック（時間・料金）', hi:'पैकेज (समय·मूल्य)', ru:'Пакет (время·цена)' },
    'venue.roomPackage': { ko:'룸 · 패키지 선택', en:'Room & package', th:'ห้อง · แพ็กเกจ', zh:'房间与套餐', ja:'部屋・パック', hi:'रूम व पैकेज', ru:'Комната и пакет' },
    'venue.lblRoom': { ko:'룸', en:'Room', th:'ห้อง', zh:'房间', ja:'部屋', hi:'रूम', ru:'Комната' },
    'venue.lblPkg': { ko:'패키지', en:'Package', th:'แพ็กเกจ', zh:'套餐', ja:'パック', hi:'पैकेज', ru:'Пакет' },
    'auth.id': { ko:'아이디 (영문 6자 이상)', en:'ID (letters, 6+ chars)', th:'ไอดี (ตัวอักษร 6+ ตัว)', zh:'账号 (字母6位以上)', ja:'ID（英字6文字以上）', hi:'आईडी (अक्षर, 6+)', ru:'ID (буквы, 6+)' },
    'auth.pw': { ko:'비밀번호 (숫자 또는 영문+숫자 6자 이상)', en:'Password (6+ with a digit)', th:'รหัสผ่าน (6+ มีตัวเลข)', zh:'密码 (6位以上含数字)', ja:'パスワード（数字含む6文字以上）', hi:'पासवर्ड (6+ अंक सहित)', ru:'Пароль (6+ с цифрой)' },
    'auth.idRule': { ko:'영문 포함 6자 이상 (영문·숫자)', en:'6+ chars, must include a letter', th:'6+ ตัว ต้องมีตัวอักษร', zh:'6位以上，须含字母', ja:'6文字以上・英字必須', hi:'6+ अक्षर, एक लेटर ज़रूरी', ru:'6+ символов, хотя бы буква' },
    'auth.pwRule': { ko:'숫자만 또는 영문+숫자, 6자 이상', en:'Digits only or letters+digits, 6+', th:'ตัวเลขล้วน หรือ ตัวอักษร+ตัวเลข 6+', zh:'纯数字或字母+数字，6位以上', ja:'数字のみ or 英数字、6文字以上', hi:'सिर्फ अंक या अक्षर+अंक, 6+', ru:'Только цифры или буквы+цифры, 6+' },
    'auth.login': { ko:'로그인', en:'Log in', th:'เข้าสู่ระบบ', zh:'登录', ja:'ログイン', hi:'लॉग इन', ru:'Войти' },
    'auth.signup': { ko:'처음이에요 · 사용가능 확인 후 시작', en:"I'm new · check & start", th:'ผู้ใช้ใหม่ · เช็คแล้วเริ่ม', zh:'新用户 · 检查并开始', ja:'新規 · 確認して開始', hi:'नया · जाँचें और शुरू करें', ru:'Новый · проверить и начать' },
    'auth.taken': { ko:'이미 사용 중인 아이디예요. 로그인하세요', en:'ID already taken. Please log in.', th:'ไอดีนี้ถูกใช้แล้ว กรุณาเข้าสู่ระบบ', zh:'账号已被使用，请登录', ja:'使用中のIDです。ログインしてください', hi:'आईडी पहले से है। लॉगिन करें।', ru:'ID занят. Войдите.' },
    'auth.fail': { ko:'로그인 실패 — 아이디/비밀번호를 확인하세요', en:'Login failed — check ID/password', th:'เข้าสู่ระบบล้มเหลว', zh:'登录失败 — 请检查账号/密码', ja:'ログイン失敗 — ID/パスワード確認', hi:'लॉगिन विफल — जाँचें', ru:'Ошибка входа — проверьте данные' },
    'auth.noperm': { ko:'이 아이디에 부여된 권한이 없어요. 운영자에게 문의하세요.', en:'No access for this ID. Contact admin.', th:'ไอดีนี้ไม่มีสิทธิ์ ติดต่อผู้ดูแล', zh:'该账号无权限，请联系管理员', ja:'権限がありません。管理者へ。', hi:'इस आईडी को अनुमति नहीं। एडमिन से संपर्क करें।', ru:'Нет доступа. Обратитесь к админу.' },
    'auth.staffNote': { ko:'관리자·매니저·마사지사도 같은 아이디로 로그인합니다', en:'Staff & therapists log in with the same form', th:'ผู้ดูแล·ผู้จัดการ·หมอนวด ใช้ฟอร์มเดียวกัน', zh:'管理员·经理·按摩师同一入口登录', ja:'管理者・マネージャー・セラピストも同じ', hi:'स्टाफ व थेरेपिस्ट भी यहीं लॉगिन', ru:'Персонал и мастера входят здесь же' },
    ...
    'spa.walkinHint': { ko:'지금 매장으로 가시면 직원이 순서대로 안내해드려요. 시간을 정해서 예약하려면 「마사지 예약」을 선택하세요.', en:'Come to the shop now — staff will seat you in order. To pick a time, choose "Book massage".', th:'มาที่ร้านได้เลย พนักงานจะจัดให้ตามคิว — หากต้องการเลือกเวลา กด「จองนวด」', zh:'现在直接到店，店员会按顺序安排。想指定时间请选「预约按摩」。', ja:'今すぐご来店ください。スタッフが順番にご案内します。時間指定は「マッサージ予約」へ。', hi:'अभी दुकान आएँ — स्टाफ़ क्रम से बैठाएगा। समय चुनने के लिए「मसाज बुक करें」चुनें।', ru:'Приходите сейчас — примут по очереди. Чтобы выбрать время — «Записаться на массаж».' },
    ...
    'spa.availNow': { ko:'지금 가능한 마사지사', en:'Available now', th:'หมอนวดที่ว่างตอนนี้', zh:'现在可约的按摩师', ja:'今すぐ可能なセラピスト', hi:'अभी उपलब्ध थेरेपिस्ट', ru:'Свободны сейчас' },
    'spa.openSlots': { ko:'가능한 시간대', en:'Open time slots', th:'ช่วงเวลาที่ว่าง', zh:'可约时段', ja:'空き時間帯', hi:'उपलब्ध समय', ru:'Свободное время' },
    'spa.walkClose': { ko:'오늘 워크인 마감', en:'Last walk-in today', th:'รับวอล์กอินถึง', zh:'今日直接到店截止', ja:'本日のウォークイン受付', hi:'आज अंतिम वॉक-इन', ru:'Приём без записи до' },
    'spa.walkClosed': { ko:'오늘 워크인 마감됐어요', en:'Walk-in closed for today', th:'ปิดรับวอล์กอินแล้ววันนี้', zh:'今日已停止到店', ja:'本日のウォークインは終了', hi:'आज वॉक-इन बंद', ru:'Приём без записи закрыт' },
    'spa.hours': { ko:'운영', en:'Open', th:'เวลาทำการ', zh:'营业', ja:'営業', hi:'खुला', ru:'Часы' },
    'spa.noneNow': { ko:'지금은 가능한 마사지사가 없어요', en:'No therapist available right now', th:'ตอนนี้ไม่มีหมอนวดว่าง', zh:'目前暂无可约按摩师', ja:'現在対応できるセラピストがいません', hi:'अभी कोई थेरेपिस्ट उपलब्ध नहीं', ru:'Сейчас нет свободных мастеров' },
    'spa.noSlotNow': { ko:'곧 가능한 시간이 없어요', en:'No openings soon', th:'ยังไม่มีเวลาว่างเร็วๆ นี้', zh:'近期暂无空档', ja:'まもなくの空きがありません', hi:'जल्दी कोई समय नहीं', ru:'Ближайших окон нет' }
  };
